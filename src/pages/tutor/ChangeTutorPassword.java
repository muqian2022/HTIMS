...
public class ChangeTutorPassword extends JFrame {
    public ChangeTutorPassword(Tutor tutor){
        ...
        confirm.addActionListener(e -> {
            String SQL = "UPDATE ht.tutor t SET t.password = '"+newPassword.getText()+"' WHERE t.tutorId = "+tutor.getTutorId()+";";
